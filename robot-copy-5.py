...
class Robot:
    ...
    def __init__(self, startPos, robotImg, map):
        ...
        self.smoothing_factor = 0.5  # Hệ số làm mượt cho vận tốc
    ...
    def move(self):
        ...
        # Đảm bảo góc quay nằm trong khoảng [-pi, pi]
...
if __name__ == "__main__":
    ...
    # start position
    start = (345, 25, np.pi/2)
    end_point = (420, 875, np.pi/2)
    running = True
    run_time = 0
    ...
    # enviroment
    env = Enviroment('C:/Users/admin/Desktop/HKII 24-25/CD_Robot_n_AI/Coding/hard-maze-1.png', end_point)
                ...
                for idx, robot in enumerate(robots):
                    if not (robot.crash or robot.is_circling or robot.no_progress or robot.is_timeout or robot.reached_goal):
                        ...
                        if current_pos in robot.dead_end_positions:
                            dead_end_penalty = 650  # tăng phạt
                        ...
                        if distance_to_goal < 10:
                            proximity_bonus = -1200  # Tăng phạt khi rất gần đích
                        if 10 < distance_to_goal < 60:  # Nếu robot ở gần đích nhưng không phải đích
                            proximity_bonus += -200  # Thêm phần thưởng nhỏ
                        ...
                        if distance_to_start < 40:  # Ngưỡng khoảng cách, có thể điều chỉnh
                        ...
                        speed_factor = 0.8 if min_distance > 20 else min_distance / 30  # Giảm tốc độ khi gần tường
                        ...
                        max_speed = 4.0  # Tùy chỉnh giá trị phù hợp
